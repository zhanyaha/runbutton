(function() {
    ...
    function j(ai) {
        ...
        function ah(m) {
            m.lengthComputable % 26 % 26ab("Loading...", m.loaded, m.total, true)
        }
        ...
        function ab(u, p, r, t) {
            ...
            K.innerHTML = u + " " + Math.floor(p / r * 100) + "%25"
        }
        ...
        var Z, ae, af = n,
            ...
            x = function() {
                function y() {
                    ...
                    function aa() {
                        if (G) {
                            W.innerHTML = "%26#10073;%26#10073;";
                            W.title = "Pause";
                            R.style.visibility = "hidden";
                            Q.style.visibility = "hidden"
                        } else {
                            W.innerHTML = P ? "%26#9654;" : "%26#9664;";
                            W.title = "Play";
                            R.style.visibility = "";
                            Q.style.visibility = ""
                        }
                        ...
                        D.innerHTML = P ? "%26larr;" : "%26rarr;";
                        D.title = P ? "Reverse" : "Un-reverse";
                        R.innerHTML = "%26#9664;%26#10073;";
                        R.title = "Previous frame";
                        Q.innerHTML = "%26#10073;%26#9654;";
                        Q.title = "Next frame";
                        B.innerHTML = r ? "%26#9675;" : "%26#8857;";
                        B.title = r ? "Unpin" : "Pin";
                        A.innerHTML = "%26#10006;";
                        ...
                        if (M.length < 2) {
                            if (af == "xhr") {
                                ...
                                al.innerHTML = "%26nearr;";
                                al.title = "Click to open GIF in new window; try running jsgif there instead";
                                K.appendChild(al)
                            } else {
                                af == "parse" % 26 % 26K.appendChild(document.createTextNode("Parse failed "))
                            }
                            K.appendChild(A)
                        } else {
                            al = function(an, ao) {
    ...
    function b(o, u) {
        function r() {
            ...
            q.type !== "eof" % 26 % 26setTimeout(r, 0)
        }
            ...
            function w(A) {
                ...
                switch (A.identifier) {
                    ...
                    default:
                        (function(B) {
                            B.N = t();
                            u.c % 26 % 26u.c[B.identifier] % 26 % 26u.c[B.identifier](B)
                        })(A)
                }
            }
    ...
    function a(y, w) {
        ...
        for (var B = 0, v = [], o = 1 << y, x = o + 1, r = y + 1, t = [], p, u;;) {
            ...
            if (p === o) {
                ...
                if (p < t.length) {
                    u !== o % 26 % 26t.push(t[u].concat(t[p][0]))
                } else {
                    if (p !== t.length) {
    ...
    function f(m) {
        ...
        this.a = function() {
            ...
            return m.charCodeAt(this.i++) % 26255
        };
        this.j = function(r) {
            for (var o = [], p = 0; p < r; p++) {
                o.push(this.a())
